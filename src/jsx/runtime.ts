...
/* ------------------------------------------------------------------ */
// Intrinsic element prop types (used by TypeScript JSX checking)
/* ------------------------------------------------------------------ */

type DataAttr = `data-${string}`;
type AriaAttr = `aria-${string}`;
type Children = MemoChild | readonly MemoChild[];
...
export namespace JSX {
  ...
  export type Children = MemoChild | readonly MemoChild[];
