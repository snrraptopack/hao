        ...
        <header class="sticky top-0 z-50 bg-white/80  shrink-0">
          <div class="mx-auto max-w-[1400px] px-6 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
              {/* Search Pill */}
              <div class="hidden md:flex items-center gap-2 px-3 py-1.5 bg-slate-100 hover:bg-slate-200/80 border border-slate-200/50 rounded-full text-xs text-slate-400 cursor-pointer transition select-none w-40">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <span>search</span>
                <span class="ml-auto text-[9px] bg-white border border-slate-200 px-1 py-0.5 rounded text-slate-400 font-mono font-bold">CTRL K</span>
              </div>

              <nav class="flex items-center gap-6 text-sm font-medium text-slate-500 font-sans">
                <Link
                  href="/docs/:slug"
                ...
                <a href="https://github.com/snrraptopack/auwla" target="_blank" rel="noopener" class="hover:text-black transition py-5">
                  <svg class="w-5 h-5 text-slate-400 hover:text-slate-900 transition" fill="currentColor" viewBox="0 0 24 24">
