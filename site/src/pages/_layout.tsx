      ...
      <header class="sticky top-0 z-50 bg-white/80  shrink-0">
        <div class="mx-auto max-w-[1400px] px-6 h-16 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            ...
            <nav class="flex items-center gap-6 text-sm font-medium text-slate-600 font-sans">
              <Link
                href="/docs/:slug"
              ...
              <a href="https://github.com/snrraptopack/hao" target="_blank" rel="noopener" aria-label="GitHub Repository" class="hover:text-black transition py-5">
