import { __componentBlock, __cloneTemplate, __computed, __createBlock, __effect, __dirtySource, __event, __hydrateElement, __hydrateComment, __keyedMap, __setChild, __setClass, __setElementText, __setProperty, __setText, __trackSources } from 'auwla';
...
function CounterExample() {
  ...
  let one = 0
  let out = __computed(() => one * 2, ['one'])

  __effect(() => {
  if (__dirty.size === 0 || __dirty.has('one')) {
  if (one > 2) {
  ...
  return __componentBlock(() => {
        ...
        let eventHandler0 = ((handler) => (event) => { __dirty.add("__all"); __dirtySource("state.count"); __dirtySource("one"); return handler(event); })(() => { state.count++; one++ });
        ...
        return __createBlock(() => ({
          ...
          if (_all) {
            eventHandler0 = ((handler) => (event) => { __dirty.add("__all"); __dirtySource("state.count"); __dirtySource("one"); return handler(event); })(() => { state.count++; one++ });
          }
          __setText(text3, out());
          __dirty.clear();
          },
...
function TodoExample() {
  ...
  if (activeBranch3 !== null) { child2 = __setChild(el0, child2, null); activeBranch3 = null; }
          ...
          if (_all) {
            eventHandler1 = ((handler) => (event) => { __dirty.add("newTodoText"); __dirtySource("newTodoText"); return handler(event); })((event) => {
            newTodoText = (event.target as HTMLInputElement).value;
          });
          }
...
function ChildCounter(props: { label: string }) {
  ...
  return __componentBlock(() => {
        ...
        const el0 = __hydrateElement("button");
        el0.className = "secondary";
        let eventHandler0 = ((handler) => (event) => { __dirty.add("count"); __dirtySource("count"); return handler(event); })(() => {
      count++;
      emit(self, "counter",{count})
        ...
        return __createBlock(() => ({
          ...
          if (_all) {
            eventHandler0 = ((handler) => (event) => { __dirty.add("count"); __dirtySource("count"); return handler(event); })(() => {
      count++;
      emit(self, "counter",{count})
    });
          }
...
function Another(props: { label: string, counter: number }) {
  return __componentBlock(() => {
        ...
        el2.append(text4);
        el0.append(el2);
        let child5 = __hydrateComment("auwla:child");
        el0.append(child5);
...
function NestedStateExample() {
  ...
  return __componentBlock(() => {
        ...
        el3.className = "row";
        const el4 = __hydrateElement("button");
        let eventHandler0 = ((handler) => (event) => { __dirty.add("parentCount"); __dirtySource("parentCount"); return handler(event); })(() => parentCount++);
        ...
        return __createBlock(() => ({
          ...
          if (_parentCount) {
            eventHandler0 = ((handler) => (event) => { __dirty.add("parentCount"); __dirtySource("parentCount"); return handler(event); })(() => parentCount++);
...
function InputPatchExample() {
  ...
  return __componentBlock(() => {
        ...
        let eventHandler0 = ((handler) => (event) => { __dirty.add("text"); __dirtySource("text"); return handler(event); })((event) => {
        ...
        return __createBlock(() => ({
          ...
          if (_all) {
            eventHandler0 = ((handler) => (event) => { __dirty.add("text"); __dirtySource("text"); return handler(event); })((event) => {
            text = (event.target as HTMLInputElement).value;
          });
          }
          __dirty.clear();
...
export function ExampleApp() {
  return __componentBlock(() => {
        ...
        const el1 = __hydrateElement("header");
